...
class EmployeeTransaction extends Component{
    ...
    componentWillMount(){
        ...
        var url  = "queries/selectReviewByEmployee?employee=resource%3Aorg.sjsu.reviewnet.Employee%23"+ this.props.userData.data.ID;
    ...
    showQuickAnalysisEmployee(){
        this.props.history.push("/employee/quick-analysis");
    }
            ...
            <div>   
                <div className="row">
                    <span style={titlestyle}>
                        Review History of {this.props.userData.data.firstName + " " + this.props.userData.data.lastName}
                    </span> 
                    <span>
                        <RaisedButton primary={true} style={{marginBottom:"40px",marginLeft:"200px",width:"200px"}} onClick={()=>this.showQuickAnalysisEmployee()}>
                            Show Quick Analysis
                        </RaisedButton>
                    </span>
...
export default withRouter(connect(mapStateToProps,matchDispatchToProps)(EmployeeTransaction));
